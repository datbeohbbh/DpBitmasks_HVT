...
namespace Task{
    ...
    void solve(){
        ...
        tuple < int,llong,llong,llong,llong,int,int> T[] = {
            {1,1,MAXVALUE_2 * 50,MAXVALUE_2 * 80,MAXVALUE_2 * 100,1,5},
            {1,MAXVALUE_2,MAXVALUE_2 * 2,MAXVALUE_2 * 4,MAXVALUE_2 * 8,6,10},
            {1,MAXVALUE / 4,MAXVALUE / 2,MAXVALUE - 10000,MAXVALUE,1,10},
            {1,1,30,MAXVALUE - 5,MAXVALUE,1,10}
        };
        int coins = rand(4);
        gentest(T[coins]);
    }
